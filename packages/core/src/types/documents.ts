...
export interface ChainConfig {
  ...
  name?: string;           // 'base', 'arbitrum', 'optimism', etc.
  rpcUrl?: string;         // for custom chains
  chainId?: number;        // for custom chains
  ...
  port?: number;
  // Public anchor (for self-hosted chains)
  publicAnchor?: {
    enabled: boolean;
    chain: string;
